...
@section('content')
    <div id="kt_content_container" class=" container-xxl ">
        <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
            action="{{ route('back.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        @enderror
                        <div class="text-muted fs-7">
                            Set Status Berita, <code>Published</code> untuk mempublikasikan berita, <code>Draft</code> untuk
                            menyimpan berita sebagai draft, <code>Archived</code> untuk menyimpan berita sebagai arsip
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-10 fv-row">
                            ...
                            <input type="text" name="title" class="form-control mb-2" placeholder="Judul Berita"
